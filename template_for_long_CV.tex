...
$for(appointment.items)$
 ...
 \hspace{0.2in} $appointment.items.dept$ \\
 $endif$
 \hspace{0.3in} $appointment.items.position$. $appointment.items.date$. \\
$endfor$
$endfor$
...
$for(education)$
\subsection{$education.degree$  \textnormal{\hspace*{\fill}$education.place$, $education.date$}}
